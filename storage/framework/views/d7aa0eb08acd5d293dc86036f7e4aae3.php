            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                            ...
                            <form action="<?php echo e(route('update', $character->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\murak\OneDrive\Asztali gép\Szerveroldali\beadando2\resources\views/edit.blade.php ENDPATH**/ ?>