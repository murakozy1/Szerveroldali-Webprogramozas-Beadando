            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <table>
                            ...
                            <?php $__currentLoopData = $characters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $character): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(route('details', ['id' => $character['id']])); ?>">click here</a></td>
                                </tr>                        
                        ...
                        <table>
                            <tr>
                                <td class="newChar"><a href="<?php echo e(route('newCharacter', ['id' => $characters[0]['user_id']])); ?>">Make New Character</a></td>
                            </tr>
                        </table>
...
<?php /**PATH C:\Users\murak\OneDrive\Asztali gép\Szerveroldali\beadando2\resources\views/dashboard.blade.php ENDPATH**/ ?>